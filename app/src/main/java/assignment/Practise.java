...
public class Practise {
    ...
    public static void main(String[] args) throws IOException {
        ...
        CSVFormat csvFormat = CSVFormat.DEFAULT.withSkipHeaderRecord().withDelimiter(',');
        CSVProcessor csvProcessor = new CSVProcessor(options.getCSVFilePath(), csvFormat);

        List<CSVRecord> records = csvProcessor.parse();
